...
export default function TaskForm() {
  const [form, setForm] = useState({ ProjectID: '', Title: '', Status: 'Pending', Deadline: '' });
  ...
  return (
    <Paper sx={{ p: 3 }}>
      ...
      <Grid container spacing={2}>
        ...
        <Grid item xs={12} md={6}><TextField label="Deadline" name="Deadline" type="date" fullWidth InputLabelProps={{ shrink: true }} value={form.Deadline} onChange={handleChange} /></Grid>
      </Grid>
